...
/* Adapted after: https://github.com/eth-infinitism/account-abstraction/blob/develop/contracts/core/EntryPoint.sol */
...
import { NonceManager } from "account-abstraction/contracts/core/NonceManager.sol";
...
contract EntryPoint is IEntryPoint, StakeManager, NonceManager, ReentrancyGuard, ERC165 {
        ...
        returns (address aggregator, bool outOfTimeRange)
    {
        ...
        Helpers.ValidationData memory data = Helpers._parseValidationData(validationData);
    ...
    function getUserOpGasPrice(MemoryUserOp memory mUserOp) internal view returns (uint256) {
        unchecked {
            ...
            return Helpers.min(maxFeePerGas, maxPriorityFeePerGas + block.basefee);
        }
    }
